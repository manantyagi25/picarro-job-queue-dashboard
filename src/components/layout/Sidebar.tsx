     ...
     >
       <div className="flex h-16 items-center justify-between px-4 border-b border-slate-200 dark:border-slate-800">
         ...
         <button
           ...
           className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
           ...
           return (
             ...
             >
               <Link
                href={item.href}
                className={
                  "flex w-full items-center rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:text-slate-200 dark:hover:bg-slate-800" +
                  (item.isActive
       ...
       <div className="border-t border-slate-200 p-3 space-y-3 dark:border-slate-800">
         <button
           ...
           className="flex w-full items-center justify-between rounded-md px-2 py-2 text-sm text-slate-700 hover:bg-slate-50 dark:text-slate-200 dark:hover:bg-slate-800"
         >
         ...
         <div className="group relative flex items-center gap-3 rounded-md px-2 py-2 hover:bg-slate-50 cursor-pointer dark:hover:bg-slate-800">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-900 text-sm font-semibold text-white dark:bg-slate-100 dark:text-slate-900">
           ...
           <div className="pointer-events-none absolute top-2 right-2 z-20 mt-2 w-28 rounded-md bg-white px-3 py-2 text-xs font-medium text-slate-700 shadow-lg ring-1 ring-slate-200 opacity-0 transition-opacity group-hover:opacity-100 dark:bg-slate-800 dark:text-slate-100 dark:ring-slate-700">
             Logout
           </div>
         </div>
       </div>
